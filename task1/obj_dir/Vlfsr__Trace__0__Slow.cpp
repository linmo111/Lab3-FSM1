...
VL_ATTR_COLD void Vlfsr___024root__trace_init_sub__TOP__0(Vlfsr___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,"data_in", false,-1, 4,1);
    tracep->declBus(c+5,"data_out", false,-1, 4,1);
    ...
    tracep->declBus(c+4,"data_in", false,-1, 4,1);
    tracep->declBus(c+5,"data_out", false,-1, 4,1);
    tracep->declBus(c+6,"sreg", false,-1, 4,1);
...
VL_ATTR_COLD void Vlfsr___024root__trace_full_sub_0(Vlfsr___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+4,(vlSelf->data_in),4);
    bufp->fullCData(oldp+5,(vlSelf->data_out),4);
    bufp->fullCData(oldp+6,(vlSelf->lfsr__DOT__sreg),4);
}
